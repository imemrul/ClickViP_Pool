...
!function (a) {
    ...
    FlipClock.List = FlipClock.Base.extend({
        ...
        fun: function(a)
        {
            var nob = {1:"১",2:"২",3:"৩",4:"৪",5:"৫",6:"৬",7:"৭",8:"৮",9:"৯",0:"০"}
            return nob[a];
        },
        createListItem: function (a, b) {
            return ['<li class="' + (a ? a : "") + '">', '<a href="#">', '<div class="up">', '<div class="shadow"></div>', '<div class="inn">' + (b ? this.fun(b) : "") + "</div>", "</div>", '<div class="down">', '<div class="shadow"></div>', '<div class="inn">' + (b ? this.fun(b) : "") + "</div>", "</div>", "</a>", "</li>"].join("")
        },
