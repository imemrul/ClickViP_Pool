                            ...
                            <tr class="font-12">
                                ...
                                <td>
                                    <?php $__currentLoopData = $client->contact_persons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact_person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p data-toggle="tooltip" data-title="<?php echo $contact_person->phone; ?>" class="margin-0">- <?php echo $contact_person->name; ?></p>
                                ...
                                <td><?php echo isset($client->creator->full_name) ? $client->creator->full_name : 'N/A'; ?></td>
