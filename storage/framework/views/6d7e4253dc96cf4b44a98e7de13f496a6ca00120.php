    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row clearfix">
                <div class="col-xs-12">
                    <h4>Live stats of Walton Campaign </h4>
                </div>
            </div>
            <div class="row clearfix">
                <div class="col-xs-4">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <table class="table table-border table-hovered text-center">
                                ...
                                <tbody>
                                <tr>
                                    <th class="text-left">Category Welcome popup (Desktop)</th>
                                    <td><span id="category_desktop_popup_view_counter"></span></td>
                                    <td><span id="category_desktop_popup_click_counter"></span></td>
                                </tr>
                                <tr>
                                    <th class="text-left">Category Welcome popup (mWeb)</th>
                                    <td><span id="category_mobile_popup_view_counter"></span></td>
                                    <td><span id="category_mobile_popup_click_counter"></span></td>
                                </tr>
    ...
    <script type="text/javascript">
        ...
        function update_stats(){
            ...
            req.then(function(resp){
                ...
                $('#category_desktop_popup_view_counter').text(res[2]+res[10]);
                $('#category_desktop_popup_click_counter').text(res[3]+res[11]);
                $('#category_mobile_popup_view_counter').text(res[4]+res[12]);
                $('#category_mobile_popup_click_counter').text(res[5]+res[13]);

                $('#search_desktop_popup_view_counter').text(res[6]);
                $('#search_desktop_popup_click_counter').text(res[7]);
                $('#search_mobile_popup_view_counter').text(res[8]);
                $('#search_mobile_popup_click_counter').text(res[9]);
            });
