...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="block-header">
            <a href="<?php echo URL::to('module/activity'); ?>" class="btn btn-sm btn-primary"> <i class="material-icons">list</i> lists of activity</a>
            <a href="<?php echo URL::to('module/activity/create'); ?>" class="btn btn-sm btn-success"> <i class="material-icons">list</i> Create new activity</a>
        </div>
        <!-- Color Pickers -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" id="app">
                        <div class="row clearfix">
                            <?php echo Form::model($data,['url'=>URL::to('module/activity',$data->id),'class'=>'form','method'=>'patch']); ?>
                                    ...
                                    <div class="body">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line" style="margin-bottom: 0px;">
                                                        <?php echo Form::text('start_time',null,['class'=>'form-control datetimepicker','placeholder'=>'Start time..']); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="input-group">
                                                    <?php echo Form::select('status',get_activity_status(),null,['class'=>'selectpicker','required'=>'required']); ?>
                                    ...
                                    <div class="body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <div class="input-group">
                                                    <?php echo Form::select('linked_with',get_linked_with_list(),null,['class'=>'selectpicker','required'=>'required','@change'=>'select_linked_with','v-model'=>'linked_with']); ?>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line autoCompleter">
                                                        ...
                                                        <?php echo Form::text('name_of_activity_with',null,['class'=>'form-control autocompleter',':placeholder'=>'title_of_linked','required'=>'required','autocomplete'=>'off']); ?>
                                                ...
                                                <div class="input-group" v-show="_.size(contact_persons) > 0">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr v-for="contact_person in contact_persons">
                                                            <td>
                                                                <input name="contact_person_ids[]" :checked="is_selected_contact_person(contact_person.id)" :value="contact_person.id" type="checkbox" :id="'contact_person_id_'+contact_person.id" class="filled-in" />
...
<?php $__env->startSection('custom_page_script'); ?>
    ...
    <script type="text/javascript">
        ...
        let app = new Vue({
            el:'#app',
            data:{
                linked_with:<?php echo $data->linked_with; ?>,
                title_of_linked:'Name of your client',
                contact_persons:<?php echo $data->contact_persons; ?>,
                linked_id:<?php echo $data->id_of_linked_with; ?>,
                selected_contact_person_ids:<?php echo $data->contact_persons; ?>
            ...
            methods:{
                is_selected_contact_person:function(contact_person_id){
                    let flag = false;
                    _.each(this.selected_contact_person_ids,function(row){
        ...
        $('.autocompleter').autoComplete({
            ...
            events: {
                search: function (qry, callback) {
                    let url = '<?php echo URL::to('module/get_link_with_suggestion'); ?>/'+app.linked_with+'?q='+$('.autocompleter').val();
            ...
            let req = axios.get('<?php echo URL::to('module/get_details_of_linked_with/'); ?>/'+app.linked_with+'/'+item.value);
