...
<a onclick="redirect('<?php echo $creative->landing_url; ?>')" href="<?php echo $creative->landing_url; ?>" target="_blank">
    <img src="<?php echo asset('public/uploads/'.$creative->creative); ?>" alt="<?php echo $creative->creative_title; ?>">
</a>
...
<script type="text/javascript">
    ...
    function talk_to_server(request_type,location){
        ...
        let req = axios.get(
            ...
            {
                params:{
                    client_id:'<?php echo $creative->campaign->client->id; ?>',
                    request_type:request_type,
                    campaign_type: '<?php echo $creative->size; ?>',
                    campaign_id: '<?php echo $creative->campaign_id; ?>',
