            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" id="app">
                        <div class="row clearfix">
                            <?php echo Form::model($campaign,['url'=>URL::to('module/campaign',$campaign->id),'class'=>'form','files'=>'true','method'=>'put']); ?>
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line autoCompleter" style="margin-bottom: 0px;">
                                                ...
                                                <?php echo Form::text('name',!empty($campaign->client) ? $campaign->client->name : '' ,['class'=>'form-control client_name_autoCompleter','placeholder'=>'Name','autocomplete'=>"off",'required'=>'required']); ?>
                                        ...
                                        <ul class="list-group" v-show="creatives.length>0">
                                            <li class="list-group-item" v-for="(row, index) in creatives">
                                                ...
                                                <div v-else class="input-group text-center" style="margin-bottom: 0; margin-top:10px;">
                                                    <img :src="'<?php echo asset("public/uploads"); ?>/'+row.creative" alt="" style="height:60px;">
                                                </div>
...
<?php $__env->startSection('custom_page_script'); ?>
    ...
    <script type="text/javascript">
        ...
        let app = new Vue({
            el:'#app',
            data:{
                creatives:JSON.parse('<?php echo $campaign->creatives; ?>'),
                client_id:<?php echo $campaign->client_id; ?>,
                creative_title:'',
                size:'',
                started_at:'',
                ended_at:'',
