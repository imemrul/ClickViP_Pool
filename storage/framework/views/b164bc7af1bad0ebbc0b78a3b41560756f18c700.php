...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="block-header">
            <a href="<?php echo URL::to('module/deals'); ?>" class="btn btn-sm btn-primary"> <i class="material-icons">list</i> lists of deals</a>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" id="app">
                        <div class="row clearfix">
                            <?php echo Form::open(['url'=>URL::to('module/deals'),'class'=>'form']); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line" style="margin-bottom: 0px;">
                                                        <?php echo Form::text('creation_date',\Carbon\Carbon::now()->toDateString(),['class'=>'form-control datepicker','placeholder'=>'Creation date..']); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-7">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="">
                                                        <?php echo Form::select('executive_ids[]',\App\User::where('roll_id',2)->pluck('full_name','id'),auth()->user()->id,['class'=>'selectpicker','multiple'=>'true','title'=>'--Executives--']); ?>
                                            ...
                                            <div class="col-xs-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="">
                                                        <?php echo Form::select('stage',get_deals_stage(),null,['class'=>'selectpicker','title'=>'--Stage--','data-width'=>'fit','required'=>'true']); ?>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line autoCompleter" style="margin-bottom: 0px;">
                                                        ...
                                                        <?php echo Form::text('client_name',null,['class'=>'form-control client_name_autoCompleter','placeholder'=>'Name','autocomplete'=>"off",'required'=>'required']); ?>
