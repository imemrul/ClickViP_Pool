...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Medicine<b> - CRM</b></a>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="<?php echo URL::to('login'); ?>">
                    <?php echo Form::token(); ?>
    ...
    <script src="<?php echo URL::to('public/js/pages/examples/sign-in.js'); ?>"></script>
</body>
