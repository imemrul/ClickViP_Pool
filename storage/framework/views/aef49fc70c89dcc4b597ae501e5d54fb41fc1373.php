                    ...
                    <div class="body" id="app">
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="card">
                                    <div class="header">
                                        <p><?php echo get_activity_list()[$client->activity_type]; ?></p>
                                    </div>
                                    <div class="body">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table class="table table-bordered table-responsive margin-0 font-12">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="width:120px;">Executive</th>
                                                        <th>Remarks</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php $__currentLoopData = $client->activities->where('type_of_activity',$client->activity_type); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td>
