                            ...
                            <div class="col-xs-7">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <p><?php echo get_activity_list()[$deal->activity_type]; ?></p>
                                                <table class="table table-bordered table-responsive margin-0 font-12">
                                                    ...
                                                    <tbody>
                                                    <?php $__currentLoopData = $deal->activities->where('type_of_activity',$deal->activity_type); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <p class="m-b-0"><?php echo isset($activity->executive->full_name) ? $activity->executive->full_name : 'N/A'; ?></p>
                                                            </td>
                                                            <td>
                                                                <p><?php echo \Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$activity->start_time)->toDateString();; ?></p>
                                                            </td>
                                                            <td>
                                                                <?php if($activity->status ==1): ?>
                                                                    <p class="btn btn-xs btn-warning"><?php echo get_activity_status()[$activity->status]; ?></p>
                                                                <?php elseif($activity->status ==2): ?>
                                                                    <p class="btn btn-xs btn-info"><?php echo get_activity_status()[$activity->status]; ?></p>
                                                                <?php else: ?>
                                                                    <p class="btn btn-xs btn-danger"><?php echo get_activity_status()[$activity->status]; ?></p>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
