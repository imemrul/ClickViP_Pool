...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="block-header">
            ...
            <a href="<?php echo URL::to('module/client/create'); ?>" class="btn btn-sm btn-success"> <i class="material-icons">list</i> Create New Client</a>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" id="app">
                        <div class="row clearfix">
                            <?php echo Form::model($client,['url'=>URL::to('module/client',$client->id),'class'=>'form','files'=>'true','method'=>'patch']); ?>
                            ...
                            <div class="col-xs-6">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="input-group">
                                            <?php echo Form::select('executive_ids[]',\App\User::where('roll_id',2)->pluck('full_name','id'),$executive_ids,['class'=>'selectpicker','title'=>'--Executive--','multiple'=>'true']); ?>

                                        </div>

                                        <?php if($client->logo): ?>
                                            <div class="input-group">
                                                <img src="<?php echo asset('public/uploads/'.$client->logo); ?>"
                                                     alt="Client logo" style="width:100px;height:100px;">
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="body">
                                        <ul class="list-group" v-show="contact_persons.length>0">
                                            <li class="list-group-item" v-for="(row, index) in contact_persons">
                                                ...
                                                <span @click="delete_contact_person_row(index,row.id)" style="position:absolute; top:5px; right:5px;" class="badge bg-pink btn btn-xs">x</span>
                                                <span v-if="row.created_by" class="contact_person_created_by" v-text="'Created by: '+row.created_by.full_name"></span>
                                            </li>
                                        </ul>
...
<?php $__env->startSection('custom_page_script'); ?>
    ...
    <script type="text/javascript">
        ...
        let app = new Vue({
            el:'#app',
            data:{
                contact_persons:<?php echo $client->contact_persons; ?>,
            ...
            methods:{
                ...
                delete_contact_person_row:function(index,contact_person_id){
                    let _this = this;
                    is_confirm(function(){
                        _this.contact_persons.splice(index, 1);
                        axios.get('<?php echo URL::to('delete_contact_person'); ?>/'+contact_person_id);
                        swal_close('Delete...');
                    },);
                }
            }
