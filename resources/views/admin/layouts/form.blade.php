...
<head>
    ...
    <!-- Colorpicker Css -->
    <link href="{!! URL::to('public/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css') !!}" rel="stylesheet" />

    <!-- Dropzone Css -->
    <link href="{!! URL::to('public/plugins/dropzone/dropzone.css') !!}" rel="stylesheet">

    <!-- Multi Select Css -->
    <link href="{!! URL::to('public/plugins/multi-select/css/multi-select.css') !!}" rel="stylesheet">

    <!-- Bootstrap Spinner Css -->
    <link href="{!! URL::to('public/plugins/jquery-spinner/css/bootstrap-spinner.css') !!}" rel="stylesheet">

    <!-- Bootstrap Tagsinput Css -->
    <link href="{!! URL::to('public/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css') !!}" rel="stylesheet">

    <!-- Bootstrap Select Css -->
    <link href="{!! URL::to('public/plugins/bootstrap-select/css/bootstrap-select.css') !!}" rel="stylesheet" />

    <!-- Bootstrap Datepicker Css -->
    <link href="{!! URL::to('public/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') !!}" rel="stylesheet" />
    ...
    <link href="{!! URL::to('public/css/snackbar.css') !!}" rel="stylesheet">
...
<script src="{!! URl::to('public/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js') !!}"></script>

<!-- Dropzone Plugin Js -->
<script src="{!! URL::to('public/plugins/dropzone/dropzone.js') !!}"></script>

<!-- Input Mask Plugin Js -->
<script src="{!! URL::to('public/plugins/jquery-inputmask/jquery.inputmask.bundle.js') !!}"></script>

<!-- Multi Select Plugin Js -->
<script src="{!! URL::to('public/plugins/multi-select/js/jquery.multi-select.js') !!}"></script>

<!-- Jquery Spinner Plugin Js -->
<script src="{!! URL::to('public/plugins/jquery-spinner/js/jquery.spinner.js') !!}"></script>

<!-- Bootstrap Tags Input Plugin Js -->
<script src="{!! URL::to('public/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js') !!}"></script>

<!-- noUISlider Plugin Js -->
<script src="{!! URL::to('public/plugins/nouislider/nouislider.js') !!}"></script>

<!-- Waves Effect Plugin Js -->
<script src="{!! URL::to('public/plugins/node-waves/waves.js') !!}"></script>

<!-- Moment Plugin Js -->
<script src="{!! URL::to('public/plugins/momentjs/moment.js') !!}"></script>

<!-- Bootstrap Material Datetime Picker Plugin Js -->
<script src="{!! URL::to('public/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js') !!}"></script>

<!-- Custom Js -->
<script src="{!! URL::to('public/js/admin.js') !!}"></script>
<script src="{!! URL::to('public/js/pages/forms/advanced-form-elements.js') !!}"></script>
<script src="{!! URL::to('public/js/vue.js') !!}"></script>
<script src="{!! URL::to('public/js/axios.js') !!}"></script>
<script src="{!! URL::to('public/js/lodash.js') !!}"></script>
