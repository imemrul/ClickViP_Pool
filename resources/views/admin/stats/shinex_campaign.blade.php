    ...
    <script type="text/javascript">
        ...
        function update_stats(){
            ...
            req.then(function(resp){
                ...
                $('#970x250_view_counter').text(res[2]+7141);
                $('#970x250_click_counter').text(res[3]);
                $('#m_web_view_counter').text(res[4]+20381);
                $('#m_web_click_counter').text(res[5]);
            });
