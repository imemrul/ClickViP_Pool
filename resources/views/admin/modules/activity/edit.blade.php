...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            ...
            <a href="{!! URL::to('module/activity/create') !!}" class="btn btn-sm btn-success"> <i class="material-icons">list</i> Create new activity</a>
        </div>
        <!-- Color Pickers -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" id="app">
                        <div class="row clearfix">
                            {!! Form::model($data,['url'=>URL::to('module/activity',$data->id),'class'=>'form','method'=>'patch']) !!}
                            <div class="col-xs-6">
                                <div class="card">
                                    <div class="header">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="input-group">
                                                    {!! Form::select('status',get_activity_status(),null,['class'=>'selectpicker','required'=>'required']) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
...
@section('custom_page_script')
    ...
    <script type="text/javascript">
        ...
        let app = new Vue({
            el:'#app',
            data:{
                linked_with:{!! $data->linked_with !!},
                title_of_linked:'Name of your client',
                contact_persons:{!! $data->contact_persons !!},
                linked_id:{!! $data->id_of_linked_with !!},
                selected_contact_person_ids:{!! $data->contact_persons !!}
