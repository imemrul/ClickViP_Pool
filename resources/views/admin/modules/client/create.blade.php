...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a href="{!! URL::to('module/client') !!}" class="btn btn-sm btn-primary"> <i class="material-icons">list</i> Patient lists</a>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" id="app">
                        <div class="row clearfix">
                            {!! Form::open(['url'=>URL::to('module/client'),'class'=>'form','files'=>'true']) !!}
                            <div class="col-xs-6">
                                <div class="card">
                                    <div class="header">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="input-group">
                                            {!! Form::select('agent_id',\App\User::where('roll_id',2)->pluck('full_name','id'),[auth()->user()->id],['class'=>'selectpicker','title'=>'--Agent--']) !!}
                                        </div>
