                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table class="tabletable-responsive margin-0 font-12">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            Creation Date: <span class="m-b-0 text-muted">{!! $deal->creation_date !!}</span>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <th>Closing Date: <span class="m-b-0 text-muted">{!! $deal->closing_date !!}</span></th>
                                                    </tr>
                                                    <tr>
                                                        <th>Amount: <span class="m-b-0 text-muted">{!! $deal->amount !!} TK</span></th>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                            @php
                                                            ...
                                                            @endphp
                                                            Contact person: <span class="m-b-0 text-muted">{!! implode(',',$contact_persons) !!}</span>
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                </table>
