...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a href="{!! URL::to('module/deals') !!}" class="btn btn-sm btn-primary"> <i class="material-icons">list</i> Deals lists</a>
            <a href="{!! URL::to('module/deals/create') !!}" class="btn btn-sm btn-success"> <i class="material-icons">list</i> Create New Deals</a>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body" id="app">
                        <div class="row clearfix">
                            {!! Form::model($data,['url'=>URL::to('module/deals',$data->id),'class'=>'form','method'=>'patch']) !!}
                            <div class="col-xs-7">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line" style="margin-bottom: 0px;">
                                                        {!! Form::text('creation_date',null,['class'=>'form-control datepicker','placeholder'=>'Creation date..']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-6">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-7">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="">
                                                        {!! Form::select('executive_ids[]',\App\User::where('roll_id',2)->pluck('full_name','id'),$assigned_executive_ids,['class'=>'selectpicker','multiple'=>'true','title'=>'--Executives--']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="">
                                                        {!! Form::select('stage',get_deals_stage(),null,['class'=>'selectpicker','title'=>'--Stage--','data-width'=>'fit']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line autoCompleter" style="margin-bottom: 0px;">
                                                        ...
                                                        {!! Form::text('client_name',$data->client->name,['class'=>'form-control client_name_autoCompleter','placeholder'=>'Name','autocomplete'=>"off",'required'=>'required']) !!}
                                                    </div>
                                                </div>
...
@section('custom_page_script')
    ...
    <script type="text/javascript">
        ...
        let app = new Vue({
            el:'#app',
            data:{
                contact_persons:{!! $clients_all_contact_persons !!},
                selected_contact_person_ids:{!! json_encode($selected_contact_person_ids) !!},
