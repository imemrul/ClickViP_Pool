    ...
    <tr>
        <td>
            ...
            @foreach($activities as $index=>$activity)
                <h4 style="margin:0px 0px;padding: 5px 3px;background:#00987717">{!! \App\User::find($index)->full_name !!}</h4>
                ...
                @foreach($activity as $row)
                    ...
                    <p style="padding:0;font-weight:700;font-size:12px;line-height:11px;margin:6px 0 0;color:#009877">
                        {!! $counter !!}. {!! $row->title !!} - <span style="color:#555;font-weight: 300;font-size:11px">{!! $activity_with !!}</span>
                    </p>
