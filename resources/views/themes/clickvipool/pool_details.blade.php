        ...
        <div class="container">
            <div class="stepper">
                <ul class="row">
                    ...
                    <li class="col-md-4">
                        <a href="{!! url('pool/payment',$recentpool->slug) !!}"><span data-text="Reservation"></span></a>
                    </li>
                    <li class="col-md-4">
                        <a href="{!! url('pool/payment/confirmation',$recentpool->slug) !!}"><span data-text="Checkout"></span></a>
                    </li>
                </ul>
            </div>
        </div>
